...
public class DataRestoran {
    ...
    public static String [][] data = new String[][]{
...

            {
                    ...
                    "Sama halnya dengan pempek beringin rajawali, pempek saga sudi mampir juga menjadi salah satu restoran dengan menu utama pempek dengan cita rasa yang tidak perlu diragukan lagi. Jangan khawatir soal harga karena disini pempek dengan cita rasa nikmat hanya memiliki harga 5 sampai 30 ribu saja, tentunya sangat terjangkau untuk makanan khas kota Palembang ini. Ditambah lagi dengan tersedianya banyak minuman jus, es, hingga kopi membuat kesan tersendiri saat menikmati pempek khas Palembang tersebut. Tentu saja akan sangat cocok untuk kita menghabiskan waktu sore ataupun malam hari di kota Palembang sambil menikmati pempek." ,
                    "https://lh5.googleusercontent.com/p/AF1QipNU6KunbI8jiCyNRhEsTMXfqIpSJWH7Gco3eZ2M=w650-h400-k-no",
                    "Alamat : l. Angkatan 45, Lorok Pakjo, Kec. Ilir Bar. I, Kota Palembang, Sumatera Selatan 30121",
                    "0711-314417",
                    "-2.976358261156878, 104.74551280509206"
            },

            {
                    "RM Sarinande Tempo Doeloe",
                    "Rumah makan di Palembang yang tak kalah keren adalah rumah makan sarinande tempo doeloe, di rumah makan ini kita akan disuguhkan dengan berbagai macam menu yang sangat menggiurkan, mulai dari olahan sambal hingga olahan pindang yang sangat nikmat. Tentu saja rumah makan ini akan sangat cocok untuk kita kunjungi bersama keluarga ataupun teman-teman kita. Hal ini dikarenakan penyajiannya yang seperti nasi padang membuat makan di rumah makan sarinande akan memiliki kesan tersendiri buat kita. Nah bagi kita yang ingin berkunjung di rumah makan ini kita bisa datang ke Jl. Mayor ruslan No.966 kota Palembang." ,
            ...
            {
                    "B777 Sky Kitchen",
                    "Bagi kita yang anti mainstream tentunya B777 sky kitchen adalah pilihan yang sangat tepat, di restoran ini kita akan disuguhkan dengan keunikan dari restoran ini yaitu dibuat menyerupai kabin pesawat terbang. Bukan hanya interiornya saja namun pelayan disini juga mengenakan seragam layaknya pramugari ataupun pramugara. Menu yang ditawarkannya juga bervariatif mulai khas Palembang hingga makanan yang berasal dari manca negara, tentunya masalah harga kita hanya perlu mengeluarkan uang 25 sampai 50 ribu saja sudah bisa menikmati makanan di restoran unik ini." ,
